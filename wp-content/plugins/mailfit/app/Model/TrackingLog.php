...
class TrackingLog extends Model
{
    ...
    protected $fillable = ['campaign_id', 'message_id', 'runtime_message_id', 'subscriber_id', 'sending_server_id', 'user_id', 'status', 'error', 'auto_trigger_id'];
    ...
    public static function filter($request)
    {
        ...
        $query = $query->leftJoin('users', 'users.id', '=', 'tracking_logs.user_id');
