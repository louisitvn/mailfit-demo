...
@section('content')
                <form action="" method="POST" class="form-validate-jqueryz tabable-select-box">
					...
					<div class="tabable-container">
						<div class="row tabable-tab latest-post">
							@include('automations.triggers._latest-post')
						</div>
						...
						<div class="row tabable-tab custom-criteria subscriber-event list-subscription list-unsubscription latest-post">
							<div class="col-md-6">
								<hr />
				...
				<script>
                    $(document).ready(function() {
						...
						$(document).on("change", "input[name='event_type']", function() {
							...
							if(type === '{{ Acelle\Model\AutoEvent::TYPE_LATEST_POST }}' || type === '{{ Acelle\Model\AutoEvent::TYPE_CUSTOM_CRITERIA }}' || type === '{{ Acelle\Model\AutoEvent::TYPE_LIST_UNSUBSCRIPTION }}' || type === '{{ Acelle\Model\AutoEvent::TYPE_LIST_SUBSCRIPTION }}') {
