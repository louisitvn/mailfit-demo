		...
		<div class="row">
			<div class="col-md-6">
				@include('helpers.form_control', [
					...
					'label' => '',
					'value' => '',
					'options' => Acelle\Model\Campaign::getSelectOptions(null, "done"),
				])
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-6">
				@include('helpers.form_control', [
					...
					'options' => Acelle\Model\MailList::getSelectOptions(),
				])
			</div>
		</div>
						...
						@foreach (Acelle\Model\Log::take(20)->get() as $log)
							...
							<div class="timeline-row">
								<div class="timeline-icon">
									<a href="#"><img src="{{ action('UserController@avatar', $log->user->uid) }}" alt=""></a>
								</div>
	
								<div class="panel panel-flat timeline-content">
									<div class="panel-heading">
										<h6 class="panel-title text-semibold">{{ $log->user->displayName() }}</h6>
