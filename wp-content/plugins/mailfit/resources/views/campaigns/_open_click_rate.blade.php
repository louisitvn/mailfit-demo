            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="content-group-sm">
                        <div class="pull-right progress-right-info text-teal-800">{{ $campaign->openUniqRate() }}%</div>
                        <h4 class="text-semibold mt-0">{{ trans('messages.open_rate') }}</h4>
                        <div class="progress progress-sm">
                            <div class="progress-bar bg-teal-400" style="width: {{ $campaign->openUniqRate() }}%">
                            </div>
                        </div>
                    </div>
                    <div class="stat-table">
                        <div class="stat-row">
                            <div class="pull-right num">
                                ...
                                <span class="text-muted2">{{ $campaign->deliveredRate() }}%</span>
                            </div>
                ...
                <div class="col-md-6">
                    <div class="content-group-sm">
                        <div class="pull-right progress-right-info text-teal-800">{{ $campaign->clickedEmailsRate() }}%</div>
                        <h4 class="text-semibold mt-0">{{ trans('messages.click_rate') }}</h4>
                        <div class="progress progress-sm">
                            <div class="progress-bar bg-teal-400" style="width: {{ $campaign->clickedEmailsRate() }}%">
                            </div>
                        </div>
                    </div>
                    <div class="stat-table">                        
